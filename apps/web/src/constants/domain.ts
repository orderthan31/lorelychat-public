...
export type RuntimeSettingDefaults = { model_key: string | null; fallback_model_key: string | null; compression_model_key: string | null; compression_fallback_model_key: string | null; effective_compression_fallback_model_key: string | null; compression_fallback_source: string; response_length_preset: string; min_output_tokens: number; compression_strategy: CompressionStrategy; options: unknown[]; compression_options: unknown[]; response_length_presets: unknown[] };
export const DEFAULT_RUNTIME_SETTING: RuntimeSettingDefaults = { model_key: null, fallback_model_key: null, compression_model_key: null, compression_fallback_model_key: null, effective_compression_fallback_model_key: null, compression_fallback_source: 'none', response_length_preset: 'medium', min_output_tokens: 768, compression_strategy: 'quality', options: [], compression_options: [], response_length_presets: [] };
